...
// Delete a party; use app.delete b/c the intention is to remove, not add
...
// Start server after DB connection (db.connect, if & console.log NOT included in instructions, but were in code review)
db.connect(err => {
    if (err) throw err;
